...
public class WeaponItemStatTemplate {
    ...
    public static class RangedWeaponStatTemplate extends WeaponStatTemplate {
        public static RangedWeaponStatTemplate RIFLE_MANNLICHER_95_DEFAULT_STATS = new RangedWeaponStatTemplate(6f,1.5f,8);
        ...
        public static RangedWeaponStatTemplate LMG_HOTCHKISS_DEFAULT_STATS = new RangedWeaponStatTemplate(4f,7.5f,75);
