...
//                "Textures/Gameplay/Decals/testBlood0.png"));
        var texture = Main.getInstance().getAssetManager().loadTexture(
                "Textures/Gameplay/Effects/blood44.png");
        texture.setMinFilter(Texture.MinFilter.NearestNoMipMaps);
        texture.setMagFilter(Texture.MagFilter.Nearest);
        mat_red.setTexture("ColorMap", texture);
...
//        blood.setRandomAngle(true);
        ...
        blood.getParticleInfluencer().setInitialVelocity(new Vector3f(0, 8, 0));
        blood.setStartSize(0.45f); //1.2f
        blood.setEndSize(0.45f); //0.6f
        blood.setGravity(0, 9, 0);
        blood.setLowLife(2_0f);
        blood.setHighLife(3_0f);
