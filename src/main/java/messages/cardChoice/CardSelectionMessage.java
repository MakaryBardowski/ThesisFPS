...
public class CardSelectionMessage extends TwoWayMessage {
    ...
    public CardSelectionMessage(int cardId1, int cardId2, int cardId3){
    ...
    public void handleClient(ClientGameAppState client) {
        enqueueExecution(()->{
            ...
            Main.getInstance().getMenuStateMachine().forceState(new CardChoiceMenuState(cardId1,cardId2,cardId3, client.getPlayer().getId(), client.getClient()));
        });
    }
}
