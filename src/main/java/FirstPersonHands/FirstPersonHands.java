...
public class FirstPersonHands {
    ...
    private static final Vector3f rootNodePosition = new Vector3f(0, -0.8f, 0.5f);
...
//    handsComposer.setCurrentAction(animData.getAnimationName());
        ...
        ((ClipAction) handsComposer.action(animData.getAnimationName())).setTransitionLength(0);
//        handsComposer.getCurrentAction().setSpeed(2);
